...
import { routeLoginUser } from "../helpers/Api"
...
export default function LoginUser() {
  ...
  async function handleSubmitForm(e: FormEvent) {
    ...
    if (emailForm.validate() && passwordForm.validate()) {
      const { url, options } = routeLoginUser({
      ...
      <section className="section-form">
        <form onSubmit={handleSubmitForm}>
          ...
          <div className="inputs-form">
            <InputBox labelName="Usuário" idName="email" typeInput="text" placeholderText="Insira seu email" {...emailForm} />
